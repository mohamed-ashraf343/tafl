<?php 
$pageTitle = 'ألبوم الصور  | مركز تعليم اللغة العربية لغير الناطقين بها - جامعة طنطا ' ;
				...
				<div class="row">
					<div class="col-12">
						<div class="bread-inner">
							<div class="bread-title"><h2 style="color: #fff">ألبوم الصور </h2></div>
						</div>
					</div>
				</div>
			</div>
	                    ...
	                    ?>
							...
							<div class="col-lg-4 col-md-4 col-12 animate_afc d2">
								<div class="single-service">
									...
									<h6>
										<a href="gallery-details.php?Album=<?=$row2['album_id']; ?>" > <?=$row2['album_title']; ?> </a>
									</h6>
									</div>
								</div>
							</div>
