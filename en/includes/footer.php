					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-6 col-12">
							...
							<div class="single-widget f-link widget">
								<h3 class="widget-title">Speed links</h3>
								<ul>
									<li><a href="about.php">About Center</a></li>
									<li><a href="goals.php">Center Aims</a></li>
									<li><a href="news.php">Center News</a></li>
						...
						<div class="col-lg-5 col-md-6 col-12">	
							...
							<div class="single-widget footer_contact widget">	
								...
								<ul class="address-widget-list">
									...
									<li class="footer-mobile-number"><i class="fa fa-map-marker"></i> <?= $row['set_address_en']?> </li>
								</ul>
							</div>		
							<!--/ End Footer Contact -->						
						</div>
					...
					<div class="row">
						<div class="col-12">
							<div class="copyright-content">
								<!-- Copyright Text -->
								<p>Copyright © <?= date("Y"); ?> All rights reserved | Designed and developed by E-Portal, Tanta University</p>
							</div>
						</div>
					</div>
				</div>
