...
<head>
		...
		<meta name='description' content='Teaching Arabic as a Foreign Language - Tanta University'/> 
		<meta property='og:locale' content='ar_AR' /> 
		<meta property="og:type" content="website" />
		<meta property='og:url' content='gittc.tanta.edu.eg' /> 
		<meta property="og:image:width" content="500" />
		<meta property="og:image:height" content="250" />
		<meta property='og:site_name' content='Teaching Arabic as a Foreign Language - Tanta University' /> 
		<meta name='twitter:card' content='summary' /> 
		<meta name='twitter:description' content='Teaching Arabic as a Foreign Language - Tanta University' />
								...
								<div class="row">
									<div class="col-lg-2 col-md-2 col-12">
										...
										<div class="logo">
											<div class="img-logo">
												<a href="index.php">
													<img src="../img/logo.png" alt="unit logo">
												</a>
														...
														<div class="menu-home-menu-container">
															...
															<ul id="nav" class="nav main-menu menu navbar-nav">
																...
																<li class="icon-active">
																	<a href="#">About Us </a>
																	<ul class="sub-menu">
																		<li><a href="about.php">About TAFL </a></li>
																		<li><a href="mission-vision.php">Mission & Vision</a></li>
																		<li><a href="goals.php">TAFL Center Aims</a></li>		
																		<li><a href="facilities.php">Facilities</a></li>		
																		<li><a href="formalities.php">Formalities</a></li>		
